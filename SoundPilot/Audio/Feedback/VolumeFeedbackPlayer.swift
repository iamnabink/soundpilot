// SoundPilot/Audio/Feedback/VolumeFeedbackPlayer.swift
import AppKit
import os
...
enum VolumeFeedback {
    ...
    /// The pop bypasses SoundPilot's taps. Software-tier devices attenuate inside the taps,
...
final class VolumeFeedbackPlayer {
    ...
    private nonisolated let logger = Logger(subsystem: "com.whoamie.soundpilot", category: "VolumeFeedbackPlayer")
    ...
    private nonisolated let queue = DispatchQueue(label: "com.whoamie.soundpilot.volume-feedback", qos: .userInitiated)
