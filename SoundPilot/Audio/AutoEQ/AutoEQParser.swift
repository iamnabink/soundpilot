// SoundPilot/Audio/AutoEQ/AutoEQParser.swift
import Foundation
import os

/// Parses EqualizerAPO ParametricEQ.txt files into AutoEQ profiles.
nonisolated enum AutoEQParser {
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.whoamie.soundpilot", category: "AutoEQParser")
