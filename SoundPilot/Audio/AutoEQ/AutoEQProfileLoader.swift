// SoundPilot/Audio/AutoEQ/AutoEQProfileLoader.swift
import Foundation
import os

/// Handles file I/O for AutoEQ profiles: managing imported profile files on disk.
nonisolated final class AutoEQProfileLoader {
    private let logger = Logger(subsystem: "com.whoamie.soundpilot", category: "AutoEQProfileLoader")

    private var importDirectory: URL {
        FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first!
            .appendingPathComponent("SoundPilot")
