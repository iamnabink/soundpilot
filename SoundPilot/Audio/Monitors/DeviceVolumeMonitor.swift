// SoundPilot/Audio/Monitors/DeviceVolumeMonitor.swift
import AppKit
import AudioToolbox
import os
...
final class DeviceVolumeMonitor: DeviceVolumeProviding {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.whoamie.soundpilot", category: "DeviceVolumeMonitor")
