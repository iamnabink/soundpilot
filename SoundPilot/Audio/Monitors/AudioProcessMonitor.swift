// SoundPilot/Audio/Monitors/AudioProcessMonitor.swift
import AppKit
import AudioToolbox
import os
...
final class AudioProcessMonitor: AudioProcessMonitoring {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.whoamie.soundpilot", category: "AudioProcessMonitor")
