// SoundPilot/Audio/Extensions/AudioDeviceID+Classification.swift
import AppKit
import AudioToolbox
...
nonisolated extension AudioDeviceID {
    ...
    ///
    /// Used to *flatten* a user-created aggregate before wrapping it in SoundPilot's own
    ...
    /// channels), so the sub-devices must be expanded into SoundPilot's aggregate directly.
