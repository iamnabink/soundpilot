// SoundPilot/Audio/DDC/DDCController.swift
...
final class DDCController {
    ...
    private let ddcQueue = DispatchQueue(label: "com.whoamie.soundpilot.ddc", qos: .utility)
    private let settingsManager: SettingsManager
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.whoamie.soundpilot", category: "DDCController")
