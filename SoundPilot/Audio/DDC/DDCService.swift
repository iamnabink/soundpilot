// SoundPilot/Audio/DDC/DDCService.swift
...
enum IOAVServiceLoader {
    ...
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.whoamie.soundpilot", category: "DDCService")
