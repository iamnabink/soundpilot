// SoundPilot/Audio/Keys/MediaKeyMonitor.swift
import AppKit
import AudioToolbox
import CoreGraphics
import os
...
final class MediaKeyMonitor {
    ...
    private let logger = Logger(subsystem: "com.whoamie.soundpilot", category: "MediaKeyMonitor")
    ...
    /// can flash the current device's transport symbol. Wired by SoundPilotApp after init.
    var iconCoordinator: MediaKeyIconFlashing?

    /// Plays the system volume-feedback pop on volume key steps. Wired by SoundPilotApp after init.
