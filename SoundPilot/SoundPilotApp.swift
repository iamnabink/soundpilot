// SoundPilot/SoundPilotApp.swift
import SwiftUI
...
private let logger = Logger(subsystem: "com.whoamie.soundpilot", category: "App")
...
struct SoundPilotApp: App {
    ...
    var body: some Scene {
        ...
        FluidMenuBarExtra("SoundPilot", image: launchIconImage, isInserted: $showMenuBarExtra) {
            menuBarContent
        }
    }
    ...
    init() {
        ...
        let resolver = TargetAppResolver(
            ownBundleID: Bundle.main.bundleIdentifier ?? "com.whoamie.soundpilot"
        )
        resolver.start()
