// SoundPilot/Views/Sheets/DeviceDetailSheet.swift
import SwiftUI
import os
...
struct DeviceDetailSheet: View {
    ...
    private static let logger = Logger(subsystem: "com.whoamie.soundpilot", category: "DeviceDetailSheet")
    ...
    private var softwareToggle: some View {
        HStack(spacing: DesignTokens.Spacing.xs) {
            ...
            Text("Use SoundPilot's software volume")
    ...
    private var calloutText: some View {
        Text("Turn on only if the volume slider doesn't work. SoundPilot remembers this for each device.")
            .font(DesignTokens.Typography.caption)
