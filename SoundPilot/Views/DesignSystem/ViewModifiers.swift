// SoundPilot/Views/DesignSystem/ViewModifiers.swift
import SwiftUI
...
struct HoverableRowModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            ...
            .padding(.vertical, 6)
            // Flat at rest; hover or keyboard focus reveals hoverSurface. Keyboard
            // focus additionally draws focusRing, so a focused row stays
            // identifiable when the pointer is hovering a different row.
            .background(
