// SoundPilot/Views/MenuBar/MenuBarIconCoordinator.swift
...
// was set to "SoundPilot" by the library, and crossfade images directly.
...
final class MenuBarIconCoordinator: MediaKeyIconFlashing {
    ...
    private let logger = Logger(subsystem: "com.whoamie.soundpilot", category: "MenuBarIconCoordinator")
    ...
    private func resolveButton() -> NSStatusBarButton? {
        ...
        for window in NSApp.windows {
            ...
            if let button = findStatusBarButton(in: contentView, matching: "SoundPilot") {
