// SoundPilot/Views/Settings/Components/AccessibilityPromptStrip.swift
import SwiftUI
...
struct AccessibilityPromptStrip: View {
    ...
    var body: some View {
        HStack(spacing: DesignTokens.Spacing.sm) {
            ...
            if showingGrantedFlourish {
                ...
                .buttonStyle(.plain)
                .accessibilityHint("Registers SoundPilot in the Accessibility list and opens System Settings.")
            }
        }
    ...
    private var message: String {
        showingGrantedFlourish
            ? "Access granted — volume keys now control SoundPilot."
            : "SoundPilot needs Accessibility to intercept F10 / F11 / F12."
    }
