// SoundPilot/Views/Settings/MediaKeyOfflineCard.swift
import SwiftUI
    ...
    var body: some View {
        HStack(alignment: .top, spacing: DesignTokens.Spacing.sm) {
            ...
            VStack(alignment: .leading, spacing: DesignTokens.Spacing.xs) {
                ...
                Text("The system disabled SoundPilot's event tap — usually after a sleep/wake cycle or a main-thread stall. Retry to reinstall it.")
        ...
        .overlay {
            RoundedRectangle(cornerRadius: DesignTokens.Dimensions.buttonRadius)
                .strokeBorder(DesignTokens.Colors.warning.opacity(0.35), lineWidth: 0.5)
