// SoundPilot/Shortcuts/TargetAppResolver.swift
import AppKit
import Foundation
...
final class TargetAppResolver: TargetAppResolving {
    ...
    private var lastNonSoundPilotFrontmostBundleID: String?
    ...
    func handleActivation(bundleID: String?) {
        ...
        lastNonSoundPilotFrontmostBundleID = bundleID
    }
    ...
    func resolveTargetBundleID(audibleCandidates: [String]) -> String? {
        ...
        guard !filtered.isEmpty else {
            return resolveFrontmostNonSoundPilot()
        }
    ...
    private func resolveFrontmostNonSoundPilot() -> String? {
        let frontmost = frontmostBundleIDProvider()
        if let frontmost, frontmost != ownBundleID {
            return frontmost
        }
        return lastNonSoundPilotFrontmostBundleID
    }
}
