// SoundPilot/Utilities/URLHandler.swift
import Foundation
import os
...
/// Handles URL scheme actions for SoundPilot (soundpilot://...)
@MainActor
final class URLHandler {
    private let audioEngine: any URLHandlerEngine
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.whoamie.soundpilot", category: "URLHandler")
    ...
    func handleURL(_ url: URL) {
        ...
        guard url.scheme == "soundpilot" else {
    ...
    /// URL format: soundpilot://set-volumes?app=com.a&volume=100&app=com.b&volume=50
    ...
    /// URL format: soundpilot://step-volume?app=com.a&direction=up (or down)
    ...
    /// URL format: soundpilot://set-mute?app=com.a&muted=true&app=com.b&muted=false
    ...
    /// URL format: soundpilot://toggle-mute?app=com.a&app=com.b
    ...
    /// URL format: soundpilot://set-device?app=com.a&device=<deviceUID>
    ...
    /// URL format: soundpilot://reset?app=com.a&app=com.b or soundpilot://reset (all apps)
