// SoundPilot/Audio/Keys/AccessibilityPermissionService.swift
import AppKit
...
final class AccessibilityPermissionService: AccessibilityTrustProviding {
    ...
    private let logger = Logger(subsystem: "com.whoamie.soundpilot", category: "AccessibilityPermissionService")
