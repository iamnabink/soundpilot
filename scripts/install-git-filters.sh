...
# DEVELOPMENT_TEAM[sdk=macosx*] value from SoundPilot.xcodeproj/project.pbxproj
...
git add --renormalize SoundPilot.xcodeproj/project.pbxproj >/dev/null 2>&1 || true
git restore --staged SoundPilot.xcodeproj/project.pbxproj >/dev/null 2>&1 || true
