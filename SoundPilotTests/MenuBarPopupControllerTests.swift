// SoundPilotTests/MenuBarPopupControllerTests.swift
import Testing
import AppKit
...
struct MenuBarPopupControllerTests {
    ...
    func noMatchingItem() {
        ...
        let controller = MenuBarPopupController(accessibilityTitle: "SoundPilotTest-NoSuchItem-\(UUID().uuidString)")
    ...
    func findLocatesMatching() {
        let title = "SoundPilotTest-Match-\(UUID().uuidString)"
    ...
    func findIgnoresNonMatching() {
        let otherTitle = "SoundPilotTest-Other-\(UUID().uuidString)"
        ...
        let controller = MenuBarPopupController(accessibilityTitle: "SoundPilotTest-Searching-\(UUID().uuidString)")
        #expect(controller.findStatusItem() == nil)
    }
    ...
    func toggleEndToEndSmoke() {
        ...
        let title = "SoundPilotTest-Smoke-\(UUID().uuidString)"
        let statusItem = NSStatusBar.system.statusItem(withLength: NSStatusItem.variableLength)
        statusItem.button?.setAccessibilityTitle(title)
        defer { NSStatusBar.system.removeStatusItem(statusItem) }
        _ = statusItem.button?.window?.windowNumber
